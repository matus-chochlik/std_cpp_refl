...
heavyweight? Won't that lead to unacceptable increases in the memory footprint
and compilation times?}

{\textbf A:} This might have been a problem if the metaobjects were regular
types and if reflection implementation was too coarse-grained or too eager.
...
assignment operators, run-time type information, etc. All they need to have
is a separate identity and their internal representation needs to have a
reference or pointer to the internal representation of the declarations\footnote{
Which the compiler needs to maintain anyway, regardless of reflection.}
which they are reflecting.
...
This operation would involve the instatiation of two metaobjects:
\begin{enumerate}
