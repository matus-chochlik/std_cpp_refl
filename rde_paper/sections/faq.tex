...
as constexpr instances of the same type? Then we could replace the metaobject
sequences with arrays of constexpr instances and the templates with constexpr
functions. Wouldn't the latter be more nice and efficient?}
...
This may not be true if the metadata is represented as instances of constexpr
...
with \say{magic} constexpr functions very similar to our templates, or we cannot
store them in an array.

Furthermore, representing metaobject sequences as arrays of such constexpr
