...
The it is necessary to extend the list of expressions which can appear
...
static_assert(is_same_v<
	meta::get_elaborated_type_specifier<reflexpr(foo)>,
	reflexpr(class)
, "");
\end{minted}

The secondary meaning of \say{extensibility}, is that
