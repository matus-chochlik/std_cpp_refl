...
\begin{minted}{cpp}
using meta_global_scope     = $reflect();
using meta_int              = $reflect(int);
using meta_std              = $reflect(std);
using meta_std_size_t       = $reflect(std::size_t);
using meta_std_thread       = $reflect(std::thread);
using meta_std_pair         = $reflect(std::pair);
using meta_std_launch       = $reflect(std::launch);
using meta_std_launch_async = $reflect(std::launch::async);
using meta_static           = $reflect(static);
using meta_public           = $reflect(public);
\end{minted}
