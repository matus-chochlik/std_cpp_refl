...
like \verb@std::reflect::Named@, \verb@std::reflect::ScopeMember@, etc. and operations
like \verb@std::reflect::is_anonymous@.}

\item{{\em integral constants} -- for operations like \verb@std::reflect::get_source_line@
or \verb@std::reflect::get_size@ and \verb@std::reflect::get_constant@.}

\item{{\em pointer constants} -- for operations like \verb@std::reflect::get_pointer@.}

\item{{\em c-string literals} -- for operations like \verb@std::reflect::get_base_name@.}

\item{{\em metaobject IDs} -- for operations like \verb@std::reflect::get_scope@,
\verb@std::reflect::get_base_classes@ or \verb@std::reflect::get_element@.}
\end{itemize}
