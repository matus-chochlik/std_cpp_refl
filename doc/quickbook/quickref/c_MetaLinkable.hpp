...
struct __source_file<MetaLinkable>
{
	...
	returns a source file path of the declaration of declaration with storage duration and/or linkage reflected by a MetaLinkable.
	>*/;
...
struct __source_line<MetaLinkable>
{
	...
	returns a source file line of the declaration of declaration with storage duration and/or linkage reflected by a MetaLinkable.
	>*/;
...
struct __source_column<MetaLinkable>
{
	...
	typedef unsigned value_type;
	static constexpr const unsigned value = ... /*<
	returns a source file column of the declaration of declaration with storage duration and/or linkage reflected by a MetaLinkable.
	>*/;
