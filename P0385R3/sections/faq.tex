...
\verb@reflect::get_pointer_v<reflexpr(variable)>@ or\\\verb@decltype(var)@ vs.
\verb@reflect::get_reflected_type_t<reflect::get_type_t<reflexpr(var)>>@, etc.}
...
\item
\begin{minted}{cpp}
reflect::object mo = reflexpr(my_ns::my_class);
