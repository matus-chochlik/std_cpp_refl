...
In a future proposal a new variant of the \texttt{reflexpr} operator
-- \texttt{reflexpr(X, Concept)} will be introduced.
This operator will return a pack of \meta{object}s reflecting members of
